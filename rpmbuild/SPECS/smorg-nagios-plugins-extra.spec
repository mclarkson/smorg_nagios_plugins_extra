...
install -m 755 check_rpmexists ${RPM_BUILD_ROOT}%_libdir/nagios/plugins/check_rpmexists
...
%_libdir/nagios/plugins/check_rpmexists
%_libdir/nagios/plugins/check_slabsize
